## code to prepare `pow_2var_cor_n30_wide_skew_sim` dataset goes here
library(sn)
system.time(
  pow_2var_cor_n30_wide_skew_sim <- crtb_lm_sim(n = 30, sim_iter = 2000, B = 2000,
                                                beta_gen = function(){
                                                  return(
                                                    list(1, #beta0
                                                         1, #beta1
...
usethis::use_data(pow_2var_cor_n30_wide_skew_sim, overwrite = TRUE)
