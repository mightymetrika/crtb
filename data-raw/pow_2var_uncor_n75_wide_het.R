## code to prepare `pow_2var_uncor_n75_wide_het` dataset goes here
system.time(
  pow_2var_uncor_n75_wide_het <- crtb_lm_sim(n = 75, sim_iter = 2000, B = 2000,
                                               beta_gen = function(){
                                                 return(
                                                   list(1, #beta0
                                                        1, #beta1
...
usethis::use_data(pow_2var_uncor_n75_wide_het, overwrite = TRUE)
