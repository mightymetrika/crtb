## code to prepare `type1_2var_uncor_n150_wide_het` dataset goes here
system.time(
  type1_2var_uncor_n150_wide_het <- crtb_lm_sim(n = 150, sim_iter = 2000, B = 2000,
                                               beta_gen = function(){
                                                 return(
                                                   list(1, #beta0
                                                        0, #beta1
...
usethis::use_data(type1_2var_uncor_n150_wide_het, overwrite = TRUE)
